    ...
    <div className="post-wapper">
      <div className="post-header">
        <div className="post-header-avatar">
          ...
          <Link to={`/profile/${post.user.slug}`}>
            <b>{post.user.fullname}</b>
          </Link>
        </div>
        <ModalActionPost post={post} />
      </div>
      ...
      <div className="post-bottom">
        <div className="post-bottom-actions">
          <div className="post-bottom-actions-left">
            <span onClick={handleToggleLike.bind(this, post._id)}>
              <svg
                aria-label="Like"
                className="_8-yf5 "
                color="#262626"
                fill={checkLike ? "red" : "#262626"}
                height="24"
                role="img"
                viewBox="0 0 48 48"
                width="24"
          ...
          <div className="post-bottom-action-right">
            <span onClick={handleToggleSave.bind(this, post._id)}>
              <svg
                aria-label="Save"
                className="_8-yf5 "
                color="#262626"
        ...
        <div className="post-bottom-info">
          <p className="post-bottom-info-view d-flex justify-content-between">
